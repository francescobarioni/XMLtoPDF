    ...
    <html>
      <head>
        ...
        <style type="text/css">
          ...
          .tableHead
          {
          font-size:small;			<!--CATA  era smaller-->
          width: 100%;
          }
		  ...
		  border: solid 1px #000000;			<!--CATA-->
		  -fs-table-paginate: paginate;			<!--CATA-->
          }
      ...
      <body>
		 <div class="header"></div> 					<!--CATA-->
         <div id="fattura-container" class="content">	<!--CATA  aggiunta class content-->
